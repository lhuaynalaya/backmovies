...
<div  class="pcs-template">
 <div id="header" class="pcs-template-header pcs-header-content">
    <span class="pcs-header-logo">
      <img src="images/consultec.jpg" style="width:200px; height: 80px">
    </span>
    <div style="text-align: justify-all; margin-left: 234px" >
      <span style="font-weight: bold;">        
      CONSULTORIA TECNICA Y CONTABLE SAC        
      </span> 
      <br>    
      JR. LOS JILGUEROS NRO. 192 URB. CORPAC - SAN ISIDRO        
      <br>    
      San Isidro, Lima,  
      <br>   
      Central Tel.:(01) 2026767     
      <br>  
    </div>
    <span class="pcs-header-orden">Orden de Pedido: {{ $numero_orden }}</span>
  </div>
  <br><br><br>
  <hr/>
