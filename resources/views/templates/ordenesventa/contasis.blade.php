...
<div  class="pcs-template">
  ...
  <div class="pcs-template-body">
    ...
    <div class="pcs-body-informacion">
      ...
      <br>
      <span>Código Ordén Venta: {{ $numero_orden }}</span>
    </div>
  </div>
  <div class="pcs-template-body">
    <div>
      <table>
        ...
        <tr>
          <td colspan="3" style="text-align: right; padding-right: 3px; font-weight: bold">Sub Total de Venta {{ $simbolo_moneda }}</td>
          ...
          @foreach($impuestos as $impuesto)
            <tr>
              <td colspan="3" style="text-align: right; padding-right: 3px; font-weight: bold">
                {{ isset($impuesto['nombre_impuesto']) ? $impuesto['nombre_impuesto']: '' }} {{ $simbolo_moneda }}
              </td>
              <td style="text-align: right; background-color: #2b6ce4; color: #ffffff">
                <span style="float: left;">
                 {{ $simbolo_moneda }}
        ...
        {{--<tr>--}}
          ...
          {{--<td style="text-align: right; background-color: #2b6ce4; color: #ffffff">{{ isset($gastos_envio) ? number_format($gastos_envio, 2): '' }}</td>--}}
        {{--</tr>--}}
        {{--<tr>--}}
        ...
        @if (isset($total_bruto) && isset($total) && number_format($total_bruto, 2) !== number_format($total, 2))
          <tr>
            <td colspan="3" style="text-align: right; padding-right: 3px; font-weight: bold">Total  {{ $simbolo_moneda }}</td>
            <td style="text-align: right; background-color: #2b6ce4; color: #ffffff">
              <span style="float: left;">
                {{ $simbolo_moneda }}
              </span>
          ...
          <tr>
            <td colspan="3" style="text-align: right; padding-right: 3px; font-weight: bold">Descuento  {{ $simbolo_moneda }}</td>
            <td style="text-align: right; background-color: #2b6ce4; color: #ffffff">
              <span style="float: left;">
                {{ $simbolo_moneda }}
              </span>
          ...
          <tr>
            <td colspan="3" style="text-align: right; padding-right: 3px; font-weight: bold">Total inc. descuento  {{ $simbolo_moneda }}</td>
