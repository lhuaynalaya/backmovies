  ...
  <div class="pcs-template-body">
    ...
    <table style="width:100%;table-layout: fixed;">
      ...
      <tr>
        <td colspan="2" style="text-align: center">
          ...
          <h2>Vendedores por tipos cliente</h2>
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="pcs-itemtable" style="width:100%;margin-top:20px;table-layout:fixed;">
      ...
      <tr style="height:32px;">
        <td class="pcs-itemtable-header pcs-itemtable-breakword" id="" style="padding: 5px 0px 5px 5px;width: 30%;text-align: left;">
          Vendedor
        </td>
        ...
        <td class="pcs-itemtable-header pcs-itemtable-breakword" id="" style="padding: 5px 10px 5px 5px;width: 10%;text-align: right;">
          Canal Referenciadores
        </td>
        <td class="pcs-itemtable-header pcs-itemtable-breakword" id="" style="padding: 5px 10px 5px 5px;width: 10%;text-align: right;">
          Canal Web
        </td>
        <td class="pcs-itemtable-header pcs-itemtable-breakword" id="" style="padding: 5px 10px 5px 5px;width: 30%;text-align: right;">
          Cuenta
        </td>
      </tr>
      </thead>
        ...
        @foreach($items as $key => $item)
          <tr>
            ...
            <td class="pcs-item-row lineitem-column text-align-right">
              {{ isset($item->a1) ? $item->a1: 0 }}
            </td>
            <td class="pcs-item-row lineitem-column text-align-right">
              {{ isset($item->a2) ? $item->a2: 0 }}
            </td>
            <td class="pcs-item-row lineitem-column text-align-right">
              {{ isset($item->a3) ? $item->a3: 0 }}
            </td>
            <td class="pcs-item-row lineitem-column text-align-right">
              {{ isset($item->a4) ? $item->a4: 0 }}
            </td>
            <td class="pcs-item-row lineitem-column">
