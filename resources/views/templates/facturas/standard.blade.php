...
<div class="pcs-template ">
  ...
  <div class="pcs-template-body">
    ...
    <table style="width:100%;table-layout: fixed;">
      ...
      <tr>
        ...
        <td class="text-align-right v-top" style="width:50%;">
          <span class="pcs-entity-title">FACTURA</span><br />
          <span class="pcs-label" style="font-size: 10pt;" id="tmp_entity_number"><b># {{ $numero_factura }}</b></span>
          <div style="clear:both;margin-top:20px;">
            <span style="font-size:8pt;"><b>Saldo Adeudado</b></span><br />
            <span style="font-size:12pt;"><b>{{ $saldo_formato }}</b></span>
          </div>
        </td>
      </tr>
      </tbody>
          ...
          <table cellpadding="0" cellspacing="0" border="0" style="width: 100%;table-layout: fixed;word-wrap: break-word;">
            ...
            <tr>
              <td class="text-align-right" style="width: 60%;padding:5px 10px 5px 0px;font-size:10pt;">
                <span class="pcs-label">Fecha de la factura:</span>
              </td>
            ...
            <tr>
              <td class="text-align-right" style="padding:5px 10px 5px 0px;font-size: 10pt;">
                <span class="pcs-label">Fecha de vencimiento:</span>
              </td>
              <td class="text-align-right">
                <span id="tmp_due_date">{{ $fecha_vencimiento }}</span>
              </td>
            </tr>
            <tr>
              <td class="text-align-right" style="padding:5px 10px 5px 0px;font-size: 10pt;">
              ...
              <td class="text-align-right">
                <span id="tmp_ref_number">{{ $numero_referencia }}</span>
              </td>
            </tr>
      ...
      <div class="v-top total-section">
        <table width="100%" border="0" cellspacing="0" class="pcs-totals">
          ...
          <tr class="pcs-balance" style="height:40px;">
            <td class="total-section-label text-align-right"><b>Saldo Adeudado</b></td>
            <td class="total-section-value text-align-right" id="tmp_balance_due"><b>{{ $saldo_formato }}</b></td>
          </tr>
          </tbody>
        </table>
      </div>
    ...
    <div style="clear:both;margin-top:50px;width:100%;">
      ...
      <p class="pcs-notes" style="margin-top:7px;white-space: pre-wrap;word-wrap: break-word;">{{ $notas }}</p>
    </div>
    ...
    <div style="clear:both;margin-top:30px;width:100%;">
      ...
      <p class="pcs-terms" style="margin-top:7px;white-space: pre-wrap;word-wrap: break-word;">{{ $terminos_condiciones }}</p>
    </div>
